...
- CSV (for any games including RPG Maker MV, MZ games, and LiveMaker files converted to CSV via [pylivemaker](https://github.com/pmrowla/pylivemaker))  
...
- NScripter scripts (see the [dedicated readme](readme/plugins/nscripter.md) for details)  
- Subtitles (.lrc, .ssa/.ass, .srt)  
  
More will be added as I see fit.  
  
![image](assets/readme/1.png)  
*All screenshots are from version 4.0.*
...
> [!NOTE]  
> They can be imported from/exported to a file named `patch.py` in the project folder. This way, you can write the code in your favorite editor and import the result.  
